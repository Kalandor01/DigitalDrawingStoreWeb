...
{
    public class GetSmtpPasswordPropertyActionCommand : AActionCommand<string>
    {
        #region Fields
        ...
        #region ctor
        public GetSmtpPasswordPropertyActionCommand()
        {
        ...
        {
            var feedbackPromise = await _feedbackPropertyService.QuerySmtpPasswordAsync();
