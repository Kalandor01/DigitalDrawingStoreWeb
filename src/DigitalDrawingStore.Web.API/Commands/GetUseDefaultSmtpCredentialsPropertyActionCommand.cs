...
{
    public class GetUseDefaultSmtpCredentialsPropertyActionCommand : AActionCommand<bool>
    {
        #region Fields
        ...
        #region ctor
        public GetUseDefaultSmtpCredentialsPropertyActionCommand()
        {
        ...
        {
            var feedbackPromise = await _feedbackPropertyService.QueryIsUseDefaultCredentialsAsync();
            ...
            if (feedbackPromise.IsOkay)
            {
                ...
                var isSuccessfullyParsed = bool.TryParse(responseString, out bool isUseDefault);
                if (isSuccessfullyParsed)
                {
                    response = isUseDefault;
                }
