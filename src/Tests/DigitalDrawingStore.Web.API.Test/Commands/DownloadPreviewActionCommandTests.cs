...
{
    public class DownloadPreviewActionCommandTests
    {
        ...
        #region ctor
        public DownloadPreviewActionCommandTests()
        {
        ...
        public async Task DACT0001_Given_CorrectValues_When_ApplyWatermark_Then_ReturnWatermarkedByteArray(string pdfPath)
        {
        ...
        [Theory]
        [MemberData(nameof(GetTestParametersForDACT0011))]
        public void DACT0011_Given_NullValues_When_CommandExecuted_Then_ThrowFeedbackException(
        ...
        #region MemberData
        public static IEnumerable<object[]> GetTestParametersForDACT0011()
        {
